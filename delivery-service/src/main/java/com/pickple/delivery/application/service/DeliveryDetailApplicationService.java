...
public class DeliveryDetailApplicationService {
    ...
    @Transactional
    public DeliveryDetailCreateResponseDto createDeliveryDetail(DeliveryDetailCreateRequestDto dto) {
        ...
        DeliveryDetail deliveryDetail = deliveryDetailRepository.save(DeliveryDetail.createFrom(dto));
